...
nmi:
  ...
  lda #$55  ; set output y position
  sta $20
  lda #$7d  ; set output x position
  sta $21
  lda #$00  ; set output attribute
  sta $22
...
output1loop:  
  ...
  sta $0200,x
  inx
  lda $21     ; set x position
  sta $0200,x
  inx

  clc
  lda #$08    ; increase x position by width of chr
  adc $21
  sta $21
  ...
  ; second output
  lda #$65  ; set output y position
  sta $20
  lda #$7d  ; set output x position
  sta $21
  lda #$02  ; set output attribute
  sta $22
